...
class ItemDump:
    ...
    def to_trade_post(self):
        ...
        if sets_str:
            items_section += constants.TRADE_POST_SETS_SECTION.format(items = sets_str)
        ...
        if su_str:
            items_section += constants.TRADE_POST_SU_SECTION.format(items = su_str)
        ...
        if ssu_str:
            items_section += constants.TRADE_POST_SSU_SECTION.format(items = ssu_str)
        ...
        if sssu_str:
            items_section += constants.TRADE_POST_SSSU_SECTION.format(items = sssu_str)
        ...
        if runewords_str:
            items_section += constants.TRADE_POST_RUNEWORDS_SECTION.format(items = runewords_str)
        ...
        if raqmoj_str:
            items_section += constants.TRADE_POST_RAQMOJ_SECTION.format(items = raqmoj_str)
        ...
        if bases_str:
            items_section += constants.TRADE_POST_BASES_SECTION.format(items = bases_str)
        ...
        if charms_str:
            items_section += constants.TRADE_POST_CHARMS_SECTION.format(items = charms_str)
        ...
        if trophies_str:
            items_section += constants.TRADE_POST_TROPHIES_SECTION.format(items = trophies_str)
        ...
        if other_str:
            items_section += constants.TRADE_POST_MISC_SECTION.format(items = other_str)

        return constants.TRADE_POST_TEMPLATE.format(items = items_section)